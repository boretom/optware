...
if [ ! -e /opt/etc/ipkg/asustor-i686-feed.conf ]
then
	echo "Creating /opt/etc/ipkg/asustor-i686-feed.conf..."
	echo "src/gz asustor-i686 file:///volume1/Optware/local-feed/asustor-i686/cross/unstable" >/opt/etc/ipkg/asustor-i686-feed.conf
fi
