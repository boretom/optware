...
if [ ! -e /opt/etc/ipkg/asustor-x86_64-feed.conf ]
then
	echo "Creating /opt/etc/ipkg/asustor-x86_64-feed.conf..."
	echo "src/gz asustor-i686 file:///volume1/Optware/local-feed/asustor-x86_64/cross/unstable" >/opt/etc/ipkg/asustor-x86_64-feed.conf
fi
