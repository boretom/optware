...
GNU_TARGET_NAME = x86_64-asustor-linux-gnu
...
TARGET_CROSS_TOP = $(BASE_DIR)/toolchain/gcc-4.3.6-glibc-2.13
...
NATIVE_GCC_VERSION=4.3.6

TOOLCHAIN_BINARY_SITE=http://$(SOURCEFORGE_MIRROR)/sourceforge/asgpl
ifeq (x86_64, $(HOST_MACHINE))
TOOLCHAIN_BINARY=x86_64-asustor-linux-gnu-64bit.tar.gz
else
TOOLCHAIN_BINARY=x86_64-asustor-linux-gnu-32bit.tar.gz
endif
